export const GEOGEBRA_DEPLOY_SCRIPT = 'https://www.geogebra.org/apps/deployggb.js';
export const GEOGEBRA_MIN_VERSION = '6.0';
export const GEOGEBRA_AUTOSAVE_DELAY = 1400;
